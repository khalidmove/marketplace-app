  ...
  const inappbrawser=async()=>{
    try {
      if (await InAppBrowser.isAvailable()) {
        await InAppBrowser.open('https://tawk.to/chat/66ea5a7783ab531891e85670/1i81n2p3t', {
        ...
        Linking.openURL('https://tawk.to/chat/66ea5a7783ab531891e85670/1i81n2p3t');
      }
      // Linking.openURL('https://tawk.to/chat/66ea5a7783ab531891e85670/1i81n2p3t').catch(() => {
      //   Alert.alert('Error', "Unable to open brawser. Make sure it's installed.");
      // });
    } catch (error) {
      console.error(error);
    }
      ...
      <DriverHeader item={t('My Account')} showback={true} />
        <View>
          ...
          <View style={{marginTop: 10}}>
            ...
            <TouchableOpacity style={[styles.box, styles.shadowProp]} onPress={()=>navigate('Myorder')}>
            ...
            <TouchableOpacity style={[styles.box, styles.shadowProp]} onPress={()=>inappbrawser()}>
            ...
            <TouchableOpacity style={[styles.box, styles.shadowProp]} onPress={ () => {
